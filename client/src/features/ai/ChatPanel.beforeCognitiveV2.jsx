    ...
    try {
      const response =
        await visionController.captureAndAnalyze(
          {
            prompt:
              "Analyse attentivement cette scène. Décris uniquement ce qui est réellement visible. Mentionne les personnes, les objets et les éléments importants du décor. Réponds en français, naturellement et clairement. Ne prétends pas voir des détails qui ne sont pas visibles.",
